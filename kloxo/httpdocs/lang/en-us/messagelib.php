...
$__emessage['phpini_not_set_pserver'] = "Need update php.ini to make sure the server able to process php files. Click <a href='/display.php?frm_action=show&frm_o_o[0][class]=pserver&frm_o_o[0][nname]=[%_server_%]&frm_o_o[1][class]=phpini'>[here]</a> to set it.";
$__emessage['phpini_not_set_client'] = "Need update php.ini to make sure your website able to process php files. Click <url:o=phpini&a=show>[here]</url> to set it.";
